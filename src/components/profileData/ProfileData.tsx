...
export const ProfileData: FC<ProfileDataPropsType> =
  ({userProfile, setEditProfile, isOwner}): ReturnComponentType => {
    ...
    return (
      <div className={style.about}>
        ...
        <h2>Contacts</h2>
        {contactKeys.map((key) => <Contact key={key} title={key}
                                           value={userProfile.contacts[key as keyof ContactsType]}/>)}
        {/*<ul >*/}
